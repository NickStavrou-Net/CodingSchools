...
namespace SQLConsoleApp
{
    class Program
    {
        static readonly string connectionstring = @"Server= DESKTOP-6VLMGU5\SQLEXPRESS;Database= Database200;Trusted_Connection=True;";
        ...
        static void Main(string[] args)
        {
            using (sqlConnection)
            {
                try
                {
                    ...
                    SqlCommand cmdInsert = new SqlCommand($"INSERT INTO UsersDetails(LoginName, PasswordHash) " +
